                            ...
                            <div className="bg-white dark:bg-zinc-800 rounded-lg p-6 max-w-md w-full">
                                ...
                                <div className="flex justify-end space-x-4">
                                    <button
                                        ...
                                        className="px-4 py-2 rounded-md border border-gray-300 dark:border-gray-600 text-zinc-700 dark:text-zinc-300 hover:bg-gray-100 dark:hover:bg-zinc-700 transition-colors cursor-pointer"
                                    >
                                        Keep Subscription
                                    </button>
